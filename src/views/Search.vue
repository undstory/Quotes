<template >
    <div class="w-full h-full bg-gray-600 text-3xl text-white-100 text-center pb-2">
        ...
        <div class="container flex mx-auto flex-col sm:flex-row py-4 w-1/2 justify-between items-center">
            ...
            <select @change="giveMeTheAuthor($event.target.value)" class="bg-transparent border-solid border-4 border-pink-400 py-2 mx-1 my-8 px-4 md:w-2/5 w-3/5 text-xl text-center hover:bg-pink-400 hover:font-semibold" name="Author" id="Author">
            ...
            <select @change="giveMeTheCategory($event.target.value)" class="bg-transparent border-solid border-4 border-pink-400 py-2 mx-1 my-8 px-4 md:w-2/5 w-3/5 text-xl text-center hover:bg-pink-400 hover:font-semibold" name="" id="">
